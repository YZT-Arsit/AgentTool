...
TIMING_ATTACK_RUNNER = ROOT / "common_action_gateway_v2" / "bin" / "canonical-v12-timing-attack-runner"
...
if os.name == "nt":
    ...
    TIMING_ATTACK_RUNNER = TIMING_ATTACK_RUNNER.with_suffix(".exe")
    ...
    def __init__(
        ...
        *,
        ...
        if runner_binary is not None:
            ...
            self.runner_binary = TIMING_ATTACK_RUNNER
