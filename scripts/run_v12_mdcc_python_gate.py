...
def main() -> int:
    ...
    record = {
        "schema": "AgentTool.V12MDCCPostChangePythonGate/1",
        ...
        "changed_source_hashes": {
            "v11_online/frameworks.py": sha(ROOT / "v11_online/frameworks.py"),
            "tests/test_v12_microsoft_depth_contract.py": sha(ROOT / "tests/test_v12_microsoft_depth_contract.py"),
            "scripts/run_v12_pir_capacity_development.py": sha(ROOT / "scripts/run_v12_pir_capacity_development.py"),
        },
        "started_ns": started,
