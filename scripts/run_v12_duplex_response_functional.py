...
def main() -> int:
    ...
    for framework in FRAMEWORKS:
        for workload in WORKLOADS:
            identity = (
                f"DEV-DTVR-V4R6-P10-{framework_code(framework)}-{workload}-001"
            )
            ...
            (args.output / identity / "response_closure_functional_unit.json").write_text(
    ...
    summary = {
        "schema": "AgentTool.V12DuplexResponseFunctionalRequalification/1",
